import { z } from "zod";
import { NOTE_KIND, NOTE_ORIGIN_TYPE } from "../constants/note_constants";
...
export const createNoteSchema = z.object({
  ...
  read_hint: z.string().max(500).nullish(),
  ...
  origin_type: z
    .enum([NOTE_ORIGIN_TYPE.HUMAN, NOTE_ORIGIN_TYPE.GENERATED, NOTE_ORIGIN_TYPE.IMPORTED])
    .default(NOTE_ORIGIN_TYPE.HUMAN),
