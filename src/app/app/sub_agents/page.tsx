...
export default async function SubagentsPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <PageHeader
        title="Sub-agents"
        description="Recent sub-agent invocations by Pog and your agents. Each invocation runs in a fresh context window so orchestrator memory stays lean."
      />
          ...
          {invocations.length === 0 ? (
            <div className="rounded-lg border border-dashed border-border bg-card/50 px-6 py-12 text-center">
              ...
              <p className="mx-auto mt-1 max-w-md text-xs text-muted-foreground">
                ...
                skill editor to make it callable by Pog. Invocations will
                appear here.
              </p>
            </div>
          ) : (
