...
/**
 * Command palette primitives, built on `cmdk` and the repo's existing
 * Base UI Dialog. No Radix dependency.
 *
 * Accessibility: the CommandDialog always renders a visually-hidden
 * DialogTitle so screen readers announce the palette correctly; the
 * underlying Dialog primitive requires a title.
 */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-hidden p-0 sm:max-w-lg">
        ...
        <Command
          className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group]]:px-2 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-3 [&_[cmdk-item]]:py-2"
        >
          {children}
        </Command>
      </DialogContent>
